#Parallel scarpping of data from amazon and flipkart
import sys
...
if __name__ == "__main__":
    ...
    begin = time.time()
    t1 = threading.Thread(target=Flipkart_extraction,args=(url1,))
    t2 = threading.Thread(target=Amazon_extraction, args=(url2,))
